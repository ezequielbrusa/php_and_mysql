...
$total = $total + ($total * $taxrate); # calculate anf add the tax.
...
echo "<p>You are  purchasing <strong>$quantity</strong> widget(s) at a cost of 
<strong>\$$price</strong> each. with tax, the total comes to <strong>\$$total</strong>.</p>\n";
