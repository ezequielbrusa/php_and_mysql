<?php # Script 9.3 -  register.php + Script 9.5 - #2
// This script perfprms an INSERT query to add a record to the users table.
...
if ($_POST['pass1'] != $_POST['pass2']) {
    ...
    if (empty($errors)) {// if everything's ok 
        ...
        if ($r) { // If it ran OK. 
            ...
            <p>You are now reistered. In chapter 12 you will actually be able to log in!</p><p><br></p>';
            ...
            // Debugging message:
            echo '<p>' . mysqli_error($dbc) . '<br><br>Query: ' . $p . '</p>';
      ...
      exit();
        ...
        echo '<h1>Error!</h1>
        <p class="error">Thre following error(s) ocurred:<br>';
